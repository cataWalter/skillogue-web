...
test.describe('Authentication', () => {
  ...
  test.describe('Reset Password Page', () => {
    test('should show an error when the link is missing required params', async ({ page }) => {
      await page.goto('/reset-password');
      await expect(
        page.getByText('Invalid or expired link. Please request a new password reset.')
      ).toBeVisible();
    });
