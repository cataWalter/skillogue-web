                    ...
                    <div className="hidden md:flex md:items-center md:space-x-4">
                        {!session && (
                            <>
                                ...
                                <Link href="/signup" className="px-4 py-2 text-sm font-medium bg-indigo-600 text-white rounded-lg hover:bg-indigo-500 transition">
                                    Sign Up
                                </Link>
                            </>
                        )}
                ...
                {isOpen && (
                    <div className="md:hidden bg-gray-900 border-t border-gray-800">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                            {!session && (
                                <>
                                    <Link href="/" onClick={() => setIsOpen(false)} className="flex items-center gap-2 px-3 py-3 md:py-2 text-base md:text-sm text-gray-300 hover:text-white hover:bg-gray-700 rounded-md transition">
                                        <Home size={18} />
                                        <span>Home</span>
                                    </Link>
                                    <Link href="/login" onClick={() => setIsOpen(false)} className="flex items-center gap-2 px-3 py-3 md:py-2 text-base md:text-sm text-gray-300 hover:text-white hover:bg-gray-700 rounded-md transition">
                                        <span>Log In</span>
                                    </Link>
                                    <Link href="/signup" onClick={() => setIsOpen(false)} className="flex items-center gap-2 px-3 py-3 md:py-2 text-base md:text-sm text-indigo-400 hover:text-indigo-300 hover:bg-gray-700 rounded-md transition">
                                        <span>Sign Up</span>
                                    </Link>
                                </>
                            )}
