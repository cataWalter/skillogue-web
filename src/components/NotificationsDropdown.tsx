        ...
        <div className="absolute right-0 mt-2 w-80 bg-gray-800 border border-gray-700 rounded-lg shadow-lg z-20">
            ...
            <div className="max-h-96 overflow-y-auto">
                {notifications.length === 0 ? (
                    <p className="text-gray-400 p-4 text-center">{componentCopy.notificationCenter.emptyState}</p>
                ) : (
                    notifications.map(n => {
                        if (!n.actorId) {
                            return (
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-gray-400">{formatDistanceToNow(new Date(n.createdAt))} {componentCopy.notificationCenter.ago}</p>
                                </div>
